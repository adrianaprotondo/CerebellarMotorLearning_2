...
function (o::OnlineGradientTrain)(sys::System,store)
    ...
    cbTrain = makeCallback_update(o.trainTimes,updateFs,recordFs,namesR,store,getN(sys))
...
function (o::OnlineGradientCompute)(sys::System,store)
    ...
    updateFs = makeFOnlineUpdate(o) # make function to update weights in callback function
    recordFs, namesR = makeFOnlineRecord(sys,o) # make function to save variable in records
    cbTrain = makeCallback_update(o.trainTimes,updateFs,recordFs,namesR,store,getN(sys),o.weights) # make callback at train times
    return [cbTe,cbTr,cbTrain]
end
...
function (o::LMSCompute)(sys::System,store)
    ...
    updateFs = makeFOnlineUpdate(o) # make function to update weights in callback function
    recordFs, namesR = makeFOnlineRecord(sys,o) # make function to save variable in records
    cbTrain = makeCallback_update(o.trainTimes,updateFs,recordFs,namesR,store,getN(sys),o.weights)
    return [cbTe,cbTr,cbTh,cbTrain] 
end
...
function (o::GaussianNoise)(sys::System,store)
    ...
    cb = makeCallback_update(o.trainTimes,[updateF],[],[],store,N)
    return [cb]
end
...
function (o::GaussianNoiseCompute)(sys::System,store)
    ...
    cb = makeCallback_update(o.trainTimes,[updateF],[],[],store,N,o.weights)
    return [cb]
end
...
function (o::GradientTrain)(sys::System,store)
    ...
    recordFs, namesR = makeFOnlineRecord(sys,o) # make function to save variable in records
    cbTrain = makeCallback_update(o.trainTimes,updateFs,recordFs,namesR,store,getN(sys)) # callback update
    return [cbTrain] 
end
